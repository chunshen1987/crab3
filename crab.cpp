...
/* For Borland C++ or for cxx on alpha vms, you should 
   comment the previous lines and uncomment */
//#define double_complex complex
//#include <complex.h>
/* +++++++++++++++++++++++++++++++++++++++++++ */
...
#include "interactions/crab_interaction_pipluspipiplus.cpp"
/* To define interactions,
						 choose/edit this file.
						 You also set the IDs of
						 particles whose phase-space
						 pt.s you wish to use here. */
#include "binnings/crab_bindefs_qinv.cpp"     /* Choose and edit to modify
						 binning. */
